...
export const CARGO_OWNER_LIST = ['Автопланирование маршрутов по 15 алгоритмам, подбор наилучшего результата',
...
export const CARRIER_LIST = ['Поиск, как новых клиентов, так и «обраток» в тендерной площадке',
