...
const CommentParagraph3: FC = () => (
  <>
    <UiParagraph>
      “Один человек ведет заявку по всем процессам: заводит заявку, планирует в маршрут,
...
const CommentParagraph4: FC = () => (
  <>
    <UiParagraph>
      “Все заявки находятся в одной системе, есть интеграция с ати.суи другими популярными
      системами.
    </UiParagraph>
    <UiParagraph>
